...
__help__ = """
 ...
 ✿ /number *:* ᴡɪʟʟ ᴘᴜʟʟ ᴛʜᴇ ɴᴏᴛᴇ ᴏꜰ ᴛʜᴀᴛ ɴᴜᴍʙᴇʀ ɪɴ ᴛʜᴇ ʟɪsᴛ
ɪꜰ ʏᴏᴜ ᴡᴏᴜʟᴅ ʟɪᴋᴇ ᴛᴏ ʀᴇᴛʀɪᴇᴠᴇ ᴛʜᴇ ᴄᴏɴᴛᴇɴᴛs ᴏꜰ ᴀ ɴᴏᴛᴇ ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ ꜰᴏʀᴍᴀᴛᴛɪɴɢ, ᴜsᴇ `/get` <ɴᴏᴛᴇɴᴀᴍᴇ> ɴᴏꜰᴏʀᴍᴀᴛ. ᴛʜɪs ᴄᴀɴ \
ʙᴇ ᴜsᴇꜰᴜʟ ᴡʜᴇɴ ᴜᴘᴅᴀᴛɪɴɢ ᴀ ᴄᴜʀʀᴇɴᴛ ɴᴏᴛᴇ
...
`buttonurl:` sᴇᴄᴛɪᴏɴ, ᴀs sᴜᴄʜ: `[somelink](buttonurl:example.com).` ᴄʜᴇᴄᴋ `/markdownhelp` ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ
 ✿ /save <ɴᴏᴛᴇɴᴀᴍᴇ>*:* sᴀᴠᴇ ᴛʜᴇ ʀᴇᴘʟɪᴇᴅ ᴍᴇssᴀɢᴇ ᴀs ᴀ ɴᴏᴛᴇ ᴡɪᴛʜ ɴᴀᴍᴇ ɴᴏᴛᴇɴᴀᴍᴇ
 sᴇᴘᴀʀᴀᴛᴇ ᴅɪꜰꜰ ʀᴇᴘʟɪᴇs ʙʏ `%%%` ᴛᴏ ɢᴇᴛ ʀᴀɴᴅᴏᴍ ɴᴏᴛᴇs
 *ᴇxᴀᴍᴘʟᴇ:* 
 `/save notename
 Reply 1
 %%%
 ...
 ✿ /removeallnotes*:* ʀᴇᴍᴏᴠᴇs ᴀʟʟ ɴᴏᴛᴇs ꜰʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ
 *ɴᴏᴛᴇ:* ɴᴏᴛᴇ ɴᴀᴍᴇs ᴀʀᴇ ᴄᴀsᴇ-ɪɴsᴇɴsɪᴛɪᴠᴇ, ᴀɴᴅ ᴛʜᴇʏ ᴀʀᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴄᴏɴᴠᴇʀᴛᴇᴅ ᴛᴏ ʟᴏᴡᴇʀᴄᴀsᴇ ʙᴇꜰᴏʀᴇ ɢᴇᴛᴛɪɴɢ sᴀᴠᴇᴅ.
