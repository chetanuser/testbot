...
from lunaBot import telethn, OWNER_ID, DEV_USERS, DRAGONS, DEMONS
...
async def zombies(event):
    ...
    if con != "clean":
        find_zombies = await event.reply("Searching For Zombies...")
    ...
    cleaning_zombies = await event.reply("Cleaning Zombies...")
    del_u = 0
    del_a = 0
    ...
    await telethn.delete_messages(chat, event.message)
