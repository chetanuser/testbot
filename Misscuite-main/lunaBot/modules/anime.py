...
__help__ = """
ɢᴇᴛ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀɴɪᴍᴇ, ᴍᴀɴɢᴀ ᴏʀ ᴄʜᴀʀᴀᴄᴛᴇʀs ꜰʀᴏᴍ [ᴀɴɪʟɪsᴛ](anilist.co).
*ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs:*
 ✿ `/anime <anime>` *:* ʀᴇᴛᴜʀɴs ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ᴀɴɪᴍᴇ.
 ✿ `/character <character>` *:* ʀᴇᴛᴜʀɴs ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ᴄʜᴀʀᴀᴄᴛᴇʀ.
 ✿ `/manga <manga>` *:* ʀᴇᴛᴜʀɴs ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴛʜᴇ ᴍᴀɴɢᴀ.
 ✿ `/user <user>` *:* ʀᴇᴛᴜʀɴs ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴀ ᴍʏᴀɴɪᴍᴇʟɪsᴛ ᴜsᴇʀ.
 ✿ `/upcoming` *:* ʀᴇᴛᴜʀɴs ᴀ ʟɪsᴛ ᴏꜰ ɴᴇᴡ ᴀɴɪᴍᴇ ɪɴ ᴛʜᴇ ᴜᴘᴄᴏᴍɪɴɢ sᴇᴀsᴏɴs.
 ✿ `/kaizoku <anime>` *:* sᴇᴀʀᴄʜ ᴀɴ ᴀɴɪᴍᴇ ᴏɴ animekaizoku.com
 ✿ `/kayo <anime>` *:* sᴇᴀʀᴄʜ ᴀɴ ᴀɴɪᴍᴇ ᴏɴ animekayo.com
 ✿ `/airing <anime>` *:* ʀᴇᴛᴜʀɴs ᴀɴɪᴍᴇ ᴀɪʀɪɴɢ ɪɴꜰᴏ.
 ✿ `/whatanime`  - ʀᴇᴘʟʏ ᴛᴏ ɢɪꜰ ᴏʀ ᴠɪᴅᴇᴏ
