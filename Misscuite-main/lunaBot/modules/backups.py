...
def export_data(update, context):
    ...
    context.bot.sendDocument(
        ...
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This [Dᴇᴠᴜ-ʀᴏʙᴏ](t.me/DEVU_ROBOT) `ʙᴀᴄᴋᴜᴘ` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
...
*ᴏɴʟʏ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀ:*
 ...
 ✿ `/import` : ʀᴇᴘʟʏ ᴛᴏ ᴛʜᴇ ʙᴀᴄᴋᴜᴘ ꜰɪʟᴇ ꜰᴏʀ ᴛʜᴇ ʙᴜᴛʟᴇʀ / ᴇᴍɪʟɪᴀ ɢʀᴏᴜᴘ ᴛᴏ ɪᴍᴘᴏʀᴛ ᴀs ᴍᴜᴄʜ ᴀs ᴘᴏssɪʙʟᴇ, ᴍᴀᴋɪɴɢ ᴛʀᴀɴsꜰᴇʀs ᴠᴇʀʏ ᴇᴀsʏ! \
 ɴᴏᴛᴇ ᴛʜᴀᴛ ꜰɪʟᴇs / ᴘʜᴏᴛᴏs ᴄᴀɴɴᴏᴛ ʙᴇ ɪᴍᴘᴏʀᴛᴇᴅ ᴅᴜᴇ ᴛᴏ ᴛᴇʟᴇɢʀᴀᴍ ʀᴇsᴛʀɪᴄᴛɪᴏɴs.
