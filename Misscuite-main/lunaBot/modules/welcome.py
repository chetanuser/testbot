...
OYO_IMG = "https://telegra.ph/file/2f6049bac1856fd66cadc.png"
...
OHOHOH_DC = "https://telegra.ph/file/96b1e9a2cd74af5e6f7f8.jpg"
DEV_DC = "https://telegra.ph/file/d4775968daf493f785151.mp4"
SUDO_DC = "https://telegra.ph/file/ba33c5361ab0a5c538ffc.mp4"
REST_DC = "https://telegra.ph/file/bcd1b421a0d952c51364e.mp4"
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_video(
                    DEV_DC,
                    caption="Be cool! A member of the Heroes Association just joined.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Support
                ...
                update.effective_message.reply_video(
                    REST_DC,
                    caption="Huh! Someone with a Demon disaster level just joined!",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_video(
                    REST_DC,
                    caption="Roar! A Tiger disaster just joined!",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_video(
                    REST_DC,
                    caption="Awoo! A Wolf disaster just joined!",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
...
SAD_MOMENT = "https://telegra.ph/file/9fbea8fa136ed140b1f47.mp4"
LOL_Z = "https://telegra.ph/file/ebe37ba02ee68d37c294f.mp4"
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_video(
                    LOL_Z,
                    caption="See you later at the Hero's Association!",
                    reply_to_message_id=reply,
                )
                return
...
__help__ = """
*ᴀᴅᴍɪɴs ᴏɴʟʏ:*
 ✿ /welcome <ᴏɴ/ᴏꜰꜰ>*:* ᴇɴᴀʙʟᴇ/ᴅɪsᴀʙʟᴇ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇs.
 ✿ /welcome *:* sʜᴏᴡs ᴄᴜʀʀᴇɴᴛ ᴡᴇʟᴄᴏᴍᴇ sᴇᴛᴛɪɴɢs.
 ✿ /welcome noformat *:* sʜᴏᴡs ᴄᴜʀʀᴇɴᴛ ᴡᴇʟᴄᴏᴍᴇ sᴇᴛᴛɪɴɢs, ᴡɪᴛʜᴏᴜᴛ ᴛʜᴇ ꜰᴏʀᴍᴀᴛᴛɪɴɢ - ᴜsᴇꜰᴜʟ ᴛᴏ ʀᴇᴄʏᴄʟᴇ ʏᴏᴜʀ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇs!
 ✿ /goodbye *:* sᴀᴍᴇ ᴜsᴀɢᴇ ᴀɴᴅ ᴀʀɢs ᴀs `/welcome`.
 ✿ /setwelcome <sᴏᴍᴇᴛᴇxᴛ>*:* sᴇᴛ ᴀ ᴄᴜsᴛᴏᴍ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ. ɪꜰ ᴜsᴇᴅ ʀᴇᴘʟʏɪɴɢ ᴛᴏ ᴍᴇᴅɪᴀ, ᴜsᴇs ᴛʜᴀᴛ ᴍᴇᴅɪᴀ.
 ✿ /setgoodbye <sᴏᴍᴇᴛᴇxᴛ>*:* sᴇᴛ ᴀ ᴄᴜsᴛᴏᴍ ɢᴏᴏᴅʙʏᴇ ᴍᴇssᴀɢᴇ. ɪꜰ ᴜsᴇᴅ ʀᴇᴘʟʏɪɴɢ ᴛᴏ ᴍᴇᴅɪᴀ, ᴜsᴇs ᴛʜᴀᴛ ᴍᴇᴅɪᴀ.
 ✿ /resetwelcome *:* ʀᴇsᴇᴛ ᴛᴏ ᴛʜᴇ ᴅᴇꜰᴀᴜʟᴛ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ.
 ✿ /resetgoodbye *:* ʀᴇsᴇᴛ ᴛᴏ ᴛʜᴇ ᴅᴇꜰᴀᴜʟᴛ ɢᴏᴏᴅʙʏᴇ ᴍᴇssᴀɢᴇ.
 ✿ /cleanwelcome <ᴏɴ/ᴏꜰꜰ>*:* ᴏɴ ɴᴇᴡ ᴍᴇᴍʙᴇʀ, ᴛʀʏ ᴛᴏ ᴅᴇʟᴇᴛᴇ ᴛʜᴇ ᴘʀᴇᴠɪᴏᴜs ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀᴠᴏɪᴅ sᴘᴀᴍᴍɪɴɢ ᴛʜᴇ ᴄʜᴀᴛ.
 ✿ /welcomemutehelp *:* ɢɪᴠᴇs ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ᴀʙᴏᴜᴛ ᴡᴇʟᴄᴏᴍᴇ ᴍᴜᴛᴇs.
 ✿ /cleanservice <ᴏɴ/ᴏꜰꜰ> *:* ᴅᴇʟᴇᴛᴇs ᴛᴇʟᴇɢʀᴀᴍs ᴡᴇʟᴄᴏᴍᴇ/ʟᴇꜰᴛ sᴇʀᴠɪᴄᴇ ᴍᴇssᴀɢᴇs. 
 *ᴇxᴀᴍᴘʟᴇ:*
ᴜsᴇʀ ᴊᴏɪɴᴇᴅ ᴄʜᴀᴛ, ᴜsᴇʀ ʟᴇꜰᴛ ᴄʜᴀᴛ.

*ᴡᴇʟᴄᴏᴍᴇ ᴍᴀʀᴋᴅᴏᴡɴ:* 
 ✿ /welcomehelp *:* ᴠɪᴇᴡ ᴍᴏʀᴇ ꜰᴏʀᴍᴀᴛᴛɪɴɢ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ꜰᴏʀ ᴄᴜsᴛᴏᴍ ᴡᴇʟᴄᴏᴍᴇ/ɢᴏᴏᴅʙʏᴇ ᴍᴇssᴀɢᴇs.
