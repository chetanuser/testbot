...
__help__ = """
 ✿ /warns <ᴜsᴇʀʜᴀɴᴅʟᴇ>*:* ɢᴇᴛ ᴀ ᴜsᴇʀ's ɴᴜᴍʙᴇʀ, ᴀɴᴅ ʀᴇᴀsᴏɴ, ᴏꜰ ᴡᴀʀɴs.
 ✿ /warnlist *:* ʟɪsᴛ ᴏꜰ ᴀʟʟ ᴄᴜʀʀᴇɴᴛ ᴡᴀʀɴɪɴɢ ꜰɪʟᴛᴇʀs
*ᴀᴅᴍɪɴs ᴏɴʟʏ:*
 ✿ /warn <ᴜsᴇʀʜᴀɴᴅʟᴇ>*:* ᴡᴀʀɴ ᴀ ᴜsᴇʀ. ᴀꜰᴛᴇʀ 3 ᴡᴀʀɴs, ᴛʜᴇ ᴜsᴇʀ ᴡɪʟʟ ʙᴇ ʙᴀɴɴᴇᴅ ꜰʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ. ᴄᴀɴ ᴀʟsᴏ ʙᴇ ᴜsᴇᴅ ᴀs ᴀ ʀᴇᴘʟʏ.
 ✿ /dwarn <ᴜsᴇʀʜᴀɴᴅʟᴇ>*:* ᴡᴀʀɴ ᴀ ᴜsᴇʀ ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ᴛʜᴇ ᴍᴇssᴀɢᴇ. ᴀꜰᴛᴇʀ 3 ᴡᴀʀɴs, ᴛʜᴇ ᴜsᴇʀ ᴡɪʟʟ ʙᴇ ʙᴀɴɴᴇᴅ ꜰʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ. ᴄᴀɴ ᴀʟsᴏ ʙᴇ ᴜsᴇᴅ ᴀs ᴀ ʀᴇᴘʟʏ.
 ✿ /resetwarn <ᴜsᴇʀʜᴀɴᴅʟᴇ>*:* ʀᴇsᴇᴛ ᴛʜᴇ ᴡᴀʀɴs ꜰᴏʀ ᴀ ᴜsᴇʀ. ᴄᴀɴ ᴀʟsᴏ ʙᴇ ᴜsᴇᴅ ᴀs ᴀ ʀᴇᴘʟʏ.
 ✿ /addwarn <ᴋᴇʏᴡᴏʀᴅ> <ʀᴇᴘʟʏ ᴍᴇssᴀɢᴇ>*:* sᴇᴛ ᴀ ᴡᴀʀɴɪɴɢ ꜰɪʟᴛᴇʀ ᴏɴ ᴀ ᴄᴇʀᴛᴀɪɴ ᴋᴇʏᴡᴏʀᴅ. ɪꜰ ʏᴏᴜ ᴡᴀɴᴛ ʏᴏᴜʀ ᴋᴇʏᴡᴏʀᴅ ᴛᴏ \
ʙᴇ ᴀ sᴇɴᴛᴇɴᴄᴇ, ᴇɴᴄᴏᴍᴘᴀss ɪᴛ ᴡɪᴛʜ ǫᴜᴏᴛᴇs, ᴀs sᴜᴄʜ: `/addwarn "very angry" This is an angry user.`
 ✿ /nowarn <ᴋᴇʏᴡᴏʀᴅ>*:* sᴛᴏᴘ ᴀ ᴡᴀʀɴɪɴɢ ꜰɪʟᴛᴇʀ
 ✿ /warnlimit <ɴᴜᴍ>*:* sᴇᴛ ᴛʜᴇ ᴡᴀʀɴɪɴɢ ʟɪᴍɪᴛ
 ✿ /strongwarn <ᴏɴ/ʏᴇs/ᴏꜰꜰ/ɴᴏ>*:* ɪꜰ sᴇᴛ ᴛᴏ ᴏɴ, ᴇxᴄᴇᴇᴅɪɴɢ ᴛʜᴇ ᴡᴀʀɴ ʟɪᴍɪᴛ ᴡɪʟʟ ʀᴇsᴜʟᴛ ɪɴ ᴀ ʙᴀɴ. ᴇʟsᴇ, ᴡɪʟʟ ᴊᴜsᴛ ᴘᴜɴᴄʜ.
