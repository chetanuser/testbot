...
from lunaBot import BOT_ID, MONGO_DB_URI
...
__help__ = """
• ᴛᴏᴏ ᴍᴀɴʏ ᴍᴇɴᴛɪᴏɴs.. Cᴀɴ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ᴛʜᴇᴍ ᴀʟʟ ᴀʟᴏɴᴇ..

Cᴏᴍᴍᴀɴᴅs (ᴏɴʟʏ ᴡᴏʀᴋ ᴏɴ ʙᴏᴛs ᴘᴍ)
/tagalert <on/off> - ᴛᴏ ᴇɴᴀʙʟᴇ ɴᴏᴛɪғɪᴄɪᴛɪᴏɴ ғᴏʀ ᴛᴀɢs ᴡʜᴇʀᴇ ᴍɪss ᴄᴜɪᴛᴇ
"""
