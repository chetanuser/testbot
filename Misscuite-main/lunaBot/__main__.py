...
MISS_CUITE = "https://telegra.ph/file/86eddd207b18ed44142f9.jpg"

PM_START_TEXT = """
❀ ʜᴇʏ {} 😇 ɪ ᴀᴍ {} 
✨ ᴛʜᴇ ᴍᴏsᴛ ᴀᴅᴠᴀɴᴄᴇ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴡɪᴛʜ ᴀ ʟᴏᴛ ᴏғ ᴀᴡᴇsᴏᴍᴇ ғᴇᴀᴛᴜʀᴇs
──────────────────
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ᴅᴇᴠᴇʟᴏᴩᴇʀ](https://t.me/MISSCUITESUPPORT) ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴘᴘᴏʀᴛ", url="t.me/misscuitesupport"
                        ),
                    ]
                ]
            ),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ", url="https://github.com/Team-misscuite"
                        ),
                    ],
                    [
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendAnimation(
                f"@{SUPPORT_CHAT}",
                animation="https://telegra.ph/file/e246bfd2b3935ff4d17cf.jpg",
                caption=f"""
